...
# --- THIS IS THE CRITICAL VARIABLE FOR THE AttributeError ---
TARGET_TEST_TURNAROUND_DAYS = 2 # Global default Target TAT in Days
# --- END CRITICAL VARIABLE ---
...
KEY_TEST_TYPES_FOR_ANALYSIS = { 
    ...
    "Hemoglobin Test": {"disease_group": "Anemia", "target_tat_days": 0.25, "critical": False, "display_name": "Hemoglobin"},
